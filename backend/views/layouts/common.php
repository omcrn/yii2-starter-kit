                ...
                <?php echo Menu::widget([
                    ...
                    'items' => [
                        ...
                        [
                            ...
                            'items' => [
                                ['label' => Yii::t('backend', 'Static pages'), 'url' => ['/i18ncontent/page/index'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
                                ['label' => Yii::t('backend', 'Articles'), 'url' => ['/i18ncontent/article/index'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
                                ['label' => Yii::t('backend', 'Article Categories'), 'url' => ['/i18ncontent/article-category/index'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
                                ['label' => Yii::t('backend', 'Text Widgets'), 'url' => ['/i18ncontent/widget-text/index'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
                                ['label' => Yii::t('backend', 'Menu Widgets'), 'url' => ['/i18ncontent/widget-menu/index'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
                                ['label' => Yii::t('backend', 'Carousel Widgets'), 'url' => ['/i18ncontent/widget-carousel/index'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
                            ]
                        ],
                        [
                        ...
                        [
                            ...
                            'options' => ['class' => 'treeview'],
                            'items' => [
                                ['label' => Yii::t('backend', 'i18n Messages'), 'url' => ['/i18ncontent/i18n/index'], 'icon' => '<i class="fa fa-flag"></i>'],
